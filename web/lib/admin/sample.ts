...
export const sampleContributions: ContributionRow[] = [
  ...
  },
  {
    ...
    share: {
      id: "p4",
      name: "Kidspace Museum classes",
      venue: null,
      neighborhoods: ["arroyo-seco"],
      age_bands: ["preschool"],
      freshness_state: "fresh",
      last_confirmed_at: now,
      validated_count: 0,
    ...
    how_much: null,
    recommendation: "yes",
    what_makes_it_great: "Hands-on and my daughter never wants to leave.",
    caveat: null,
    ...
    confidence: 0.68,
    confidence_note:
      "Names a specific reaction, but there's no sense of the age this fits — worth asking before it's usable.",
    needs_detail_note: "Quick one — how old was your daughter for this?",
    provenance: "parent_submitted",
    contributor: { id: "c3", name: "Sample Parent C" },
    is_test: false,
    created_at: now,
  },
  {
...
export const sampleFlags: FlagRow[] = [
  {
    id: "f1",
    severity: "escalation",
    reason: "named_allegation",
    excerpt:
      "A negative claim about a named caregiver. Read it and nothing else — it is never quoted or circulated.",
    field: null,
    subject: {
      kind: "demand_signal",
      id: "d3",
      title: "Sample question about a caregiver",
      wrote: [{ field: "question_text", body: "Sample only — a parent describing something that worried them about someone by name." }],
    },
    contributor: { id: "c2", name: "Sample Parent B" },
    status: "open",
    confidence: null,
  ...
  },
  {
    ...
    excerpt:
      "Names an individual teacher. A strong recommendation — it needs a person to read it, not a lower score.",
    field: null,
    subject: {
      kind: "share_contribution",
      id: "a1",
      title: "Little Maestros",
      wrote: [{ field: "what_makes_it_great", body: "Sample only — a parent praising one teacher by name and saying to ask for her class." }],
    },
    contributor: { id: "c1", name: "Sample Parent A" },
    status: "open",
    confidence: 0.86,
  ...
  },
  {
    ...
    excerpt: "The parent said themselves it was over a year ago.",
    field: "last_there",
    subject: {
      kind: "share_contribution",
      id: "a2",
      title: "Rose Bowl Aquatics parent & me",
      wrote: [],
    },
    contributor: null,
    status: "open",
...
export const sampleInvites: InviteRow[] = [
  ...
  },
  {
    ...
    school_option_value: "walden-school",
    referrer_name: null,
