      ...
      <div className="px-4 py-3">
        ...
        <ul className="mt-3">
          {places.rows.map((r) => (
            ...
            >
              {/* `Heading`, not a hardcoded tag: with the card's own title gone
                  the level comes from the context, so these land at h2 under the
                  page heading exactly as the question cards in the other panel
                  do. Hardcoded `h3` is what made this panel jump a level the
                  moment the h2 above it went — the 7 Sep fault, reintroduced by
                  removing a heading. */}
